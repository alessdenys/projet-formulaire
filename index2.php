...
<head>
  ...
  <title>Hackers Poulette Pi Boards</title>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="Images/pi-4-model-B.png" alt="Pi 4 model B"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Pi 4 Model B</a>
                </h4>
                <h5>40€</h5>
                <p class="card-text">We've listened to your feedback: with Raspberry Pi 4, you can run two monitors at once — and in 4K, too!</p>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="Images/pi-3-model-A+.jpg" alt="Raspberry Pi 3 model A+"></a>
              <div class="card-body">
                <h4 class="card-title">
                  <a href="#">Raspberry Pi 3 model A+</a>
                </h4>
                <h5>35,99€</h5>
                <p class="card-text">1.4GHz 64-bit quad-core processor, dual-band wireless LAN, Bluetooth 4.2/BLE in the same mechanical format as the Raspberry Pi 1 Model A+
              </p>
              </div>
              <div class="card-footer">
                <small class="text-muted">&#9733; &#9733; &#9733; &#9733; &#9734;</small>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="card h-100">
              <a href="#"><img class="card-img-top" src="Images/pi3-model-B+.jpg" alt="Raspberry Pi 3 model B+"></a>
              <div class="card-body">
                <h4 class="card-title">
